; ModuleID = 'contract.cpp'
source_filename = "contract.cpp"
...
@.str = private unnamed_addr constant [11 x i8] c"contract: \00", align 1
...
20:                                               ; preds = %17
  %21 = call noundef double @_Z6mysqrtd(double noundef 2.000000e+00)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_contract.cpp() #0 section ".text.startup" {
